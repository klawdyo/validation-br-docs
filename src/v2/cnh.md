---
outline: deep
title: CNH — validação da Carteira de Habilitação
description: Valide a CNH em JavaScript ou TypeScript, confira os dois dígitos verificadores da Carteira Nacional de Habilitação e gere exemplos para testes.
---
